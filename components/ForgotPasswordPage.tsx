                    ...
                    <div className="flex flex-col flex-grow justify-center max-w-[420px] w-full mx-auto">
                        ...
                        <form onSubmit={handleReset} className="space-y-5">
                            ...
                            <div className="flex justify-end pt-1">
                                <Link to="/login" className="text-xs font-black uppercase tracking-widest text-primary hover:text-primary-hover transition-colors">
                                    Voltar ao login
                                </Link>
                            </div>
                            ...
                            <div className="relative flex py-4 items-center">
                                ...
                                <span className="flex-shrink-0 mx-4 text-gray-400 dark:text-gray-500 text-[10px] font-black uppercase tracking-[0.3em]">Recuperação de Senha</span>
                                <div className="flex-grow border-t border-gray-100 dark:border-gray-700"></div>
                            </div>
